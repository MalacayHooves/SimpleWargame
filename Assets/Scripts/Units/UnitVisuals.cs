...
namespace SimpleWargame
{
    public class UnitVisuals : MonoBehaviour
    {
        ...
        public async Task PlayMeleeAttackAnimation(Vector3 enemyDirection)
        {
            ...
            attackVisual.transform.position = (transform.position + enemyDirection)/2;
        ...
        public async Task PlayRangedAttackAnimation(Vector3 enemyDirection)
        {
            enemyDirection.z = transform.position.z;
